...
# ==============================================================================
#
# This script is used to run local test on CITYSCAPES VOC 2012 using MobileNet-v2.
...
EXP_FOLDER="exp/train_on_trainval_set_xception_65_cityscapes"
...
CKPT_NAME="deeplabv3_cityscapes_train"
TF_INIT_CKPT="${CKPT_NAME}_2018_02_06.tar.gz"
